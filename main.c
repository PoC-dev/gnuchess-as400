/*
 * GNU Chess 5.0 - main.c - entry point Copyright (c) 1999-2002 Free Software
 * Foundation, Inc.
 *
...
int nmovesfrombook;                      /* Number of moves since last book
                                          * move */
...
int bookloaded = 0;                      /* Is the book loaded already into
                                          * memory? */
...
char algbr[64][3] = { "a1", "b1", "c1", "d1", "e1", "f1", "g1", "h1",
...
int Shift00[64] = { 56, 56, 56, 56, 56, 56, 56, 56,
...
int r90[64] = { A8, A7, A6, A5, A4, A3, A2, A1,
...
int Shift90[64] = { 0, 8, 16, 24, 32, 40, 48, 56,
...
int r45[64] = { E4, F3, H2, C2, G1, D1, B1, A1,
...
int Shift45[64] = { 28, 36, 43, 49, 54, 58, 61, 63,
...
int Mask45[64] = { 0xFF, 0x7F, 0x3F, 0x1F, 0x0F, 0x07, 0x03, 0x01,
...
int r315[64] = { A1, C1, F1, B2, G2, E3, D4, D5,
...
int Shift315[64] = { 63, 61, 58, 54, 49, 43, 36, 28,
...
int Mask315[64] = { 0x01, 0x03, 0x07, 0x0F, 0x1F, 0x3F, 0x7F, 0xFF,
    0x03, 0x07, 0x0F, 0x1F, 0x3F, 0x7F, 0xFF, 0x7F,
    0x07, 0x0F, 0x1F, 0x3F, 0x7F, 0xFF, 0x7F, 0x3F,
    0x0F, 0x1F, 0x3F, 0x7F, 0xFF, 0x7F, 0x3F, 0x1F,
    0x1F, 0x3F, 0x7F, 0xFF, 0x7F, 0x3F, 0x1F, 0x0F,

/*
 * GNU Chess 5.0 - atak.c - attack code Copyright (c) 1999-2002 Free Software
 * Foundation, Inc.
 *
 ...
 *************************************************************************/
{
    ...
    for (side = white; side <= black; side++) {
        ...
        a0 = Ataks[side];
        a0[0] =
            a0[pawn] | a0[knight] | a0[bishop] | a0[rook] | a0[queen] |
            a0[king];
    }
}
 ...
 ***************************************************************************/
{
    ...
    switch (piece) {
        ...
        case knight:
            ...
            break;
        case bishop:                    /* falls through as queens move
                                          * diagnonally */
        case queen:
            ...
            if (piece == bishop)         /* Queen falls through as they move
                                          * like rooks */
                break;
            blocker = board.blocker;
        case rook:
